...
class Projector(object):
    ...
    def __init__(self,
                 ...
                 src_ac,
                 dst_ac,
                 src_alt_aln_method=vvhgvs.global_config.mapping.alt_aln_method,
                 dst_alt_aln_method=vvhgvs.global_config.mapping.alt_aln_method):
        self.hdp = hdp
        self.alt_ac = alt_ac
        self.src_tm = vvhgvs.alignmentmapper.AlignmentMapper(hdp, src_ac, alt_ac, src_alt_aln_method)
        self.dst_tm = vvhgvs.alignmentmapper.AlignmentMapper(hdp, dst_ac, alt_ac, dst_alt_aln_method)
    ...
    def project_interval_forward(self, c_interval):
        ...
        :param c_interval: an :class:`vvhgvs.interval.Interval` object on the source transcript
        :returns: c_interval: an :class:`vvhgvs.interval.Interval` object on the destination transcript
        """
    ...
    def project_interval_backward(self, c_interval):
        ...
        :param c_interval: an :class:`vvhgvs.interval.Interval` object on the destination transcript
        :returns: c_interval: an :class:`vvhgvs.interval.Interval` object on the source transcript
        """
    ...
    def project_variant_forward(self, c_variant):
        ...
        :param c_variant: an :class:`vvhgvs.sequencevariant.SequenceVariant` object on the source transcript
        :returns: c_variant: an :class:`vvhgvs.sequencevariant.SequenceVariant` object on the destination transcript
        """

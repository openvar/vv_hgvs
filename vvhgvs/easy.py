"""simplified imports for the vvhgvs package

`vvhgvs.easy` simplifies using the vvhgvs package by providing a single
import path and objects that are instantiated with common defaults.

With default logging levels, using vvhgvs.easy is straightforward and
requires no code changes::

    >> from vvhgvs.easy import parser, projector
...
`vvhgvs.easy` also introduces new functional forms for common methods.
For example::

    >> from vvhgvs.easy import parse, get_relevant_transcripts, g_to_t
...
from vvhgvs import __version__, global_config    # noqa: F401
from vvhgvs.assemblymapper import AssemblyMapper
from vvhgvs.dataproviders.uta import connect
from vvhgvs.normalizer import Normalizer
from vvhgvs.parser import Parser
from vvhgvs.validator import Validator
from vvhgvs.variantmapper import VariantMapper

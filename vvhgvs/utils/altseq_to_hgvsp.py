...
class AltSeqToHgvsp(object):
    ...
    def build_hgvsp(self):
        """Compare two amino acid sequences; generate an vvhgvs tag from the output
    ...
    def _create_variant(self,
        ...
        if is_ambiguous:
            ...
            posedit = PosEdit(pos=interval, edit=edit, uncertain=vvhgvs.global_config.mapping.inferred_p_is_uncertain)
        var_p = vvhgvs.sequencevariant.SequenceVariant(acc, 'p', posedit)
        return var_p

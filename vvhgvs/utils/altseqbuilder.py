# -*- coding: utf-8 -*-
"""Utility to insert an vvhgvs variant into a transcript sequence.
...
class AltSeqBuilder(object):
    ...
    def __init__(self, var_c, transcript_data):
        ...
        :param var_c: representation of vvhgvs variant
    ...
    def _incorporate_repeat(self):
        ...
        raise NotImplementedError("vvhgvs c to p conversion does not support {} type: repeats".format(self._var_c))

# -*- coding: utf-8 -*-
"""start IPython shell with vvhgvs initialized. Intended to be used for
...
header_string = """############################################################################
vvhgvs-shell -- interactive vvhgvs
vvhgvs version: {v}
...
def shell():
    ...
    from vvhgvs.easy import (    # noqa: F401
    ...
    from vvhgvs.utils.context import variant_context_w_alignment    # noqa

...
from vvhgvs.exceptions import HGVSError, HGVSUsageError, HGVSDataNotAvailableError, HGVSInvalidIntervalError
...
class AlignmentMapper(object):
    ...
    def g_to_n(self, g_interval):
        ...
        return vvhgvs.location.BaseOffsetInterval(
            start=vvhgvs.location.BaseOffsetPosition(base=frs + 1, offset=frs_offset, datum=Datum.SEQ_START),
            end=vvhgvs.location.BaseOffsetPosition(base=fre + 1, offset=fre_offset, datum=Datum.SEQ_START),
    ...
    def n_to_g(self, n_interval):
        ...
        return vvhgvs.location.Interval(
            start=vvhgvs.location.SimplePosition(gs, uncertain=n_interval.start.uncertain),
            end=vvhgvs.location.SimplePosition(ge, uncertain=n_interval.end.uncertain),

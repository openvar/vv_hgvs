...
class AssemblyMapper(VariantMapper):
    ...
    * A new method, relevant_trancripts(g_variant), returns a list of
    ...
    def __init__(self,
                 hdp,
                 assembly_name=vvhgvs.global_config.mapping.assembly,
                 alt_aln_method=vvhgvs.global_config.mapping.alt_aln_method,
                 normalize=vvhgvs.global_config.mapping.normalize,
                 prevalidation_level=vvhgvs.global_config.mapping.prevalidation_level,
                 in_par_assume=vvhgvs.global_config.mapping.in_par_assume,
                 replace_reference=vvhgvs.global_config.mapping.replace_reference,
                 *args,
                 **kwargs):
        """
        :param object hdp: instance of vvhgvs.dataprovider subclass
        ...
        self._norm = None
        if self.normalize:
            self._norm = vvhgvs.normalizer.Normalizer(hdp, alt_aln_method=alt_aln_method, validate=False)

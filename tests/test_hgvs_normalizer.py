...
class Test_HGVSNormalizer(unittest.TestCase):
    ...
    def test_c_normalizer(self):
        ...
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.31del"))), "NM_001166478.1:c.35del")
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "NM_001166478.1:c.36_37dup")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.2_7delinsTTTAGA"))),
            "NM_001166478.1:c.3_4delinsTT")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.30_31insT"))),
            "NM_001166478.1:c.35dup")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.59delG"))), "NM_001166478.1:c.61del")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.36_37insTCTCTC"))),
            "NM_001166478.1:c.37_38insCTCTCT")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.14_15insT"))), "NM_000051.3:c.15dup")
        ...
        self.assertEqual(
            ...
            "NM_000088.3:c.590_599inv")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.34del"))), "NM_001166478.1:c.31del")
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            "NM_001166478.1:c.35_36dup")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.2_7delinsTTTAGA"))),
            "NM_001166478.1:c.3_4delinsTT")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.30_31insT"))),
            "NM_001166478.1:c.31dup")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.61delG"))), "NM_001166478.1:c.59del")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.36_37insTCTCTC"))),
            "NM_001166478.1:c.34_35insTCTCTC")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.14_15insT"))), "NM_000051.3:c.14dup")

        #Around exon-intron boundary
        self.assertEqual(
            str(self.normc.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.59delG"))), "NM_001166478.1:c.60del")
        self.assertEqual(
            str(self.norm5c.normalize(self.hp.parse_hgvs_variant("NM_001166478.1:c.61delG"))), "NM_001166478.1:c.61del")
        self.assertEqual(
        ...
        #UTR variants
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.-5_-4insA"))), "NM_000051.3:c.-3dup")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.-4_-3insAC"))), "NM_000051.3:c.-3_-2dup")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.-2_-1insCA"))), "NM_000051.3:c.-1_1dup")
        ...
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.-4_-3insA"))), "NM_000051.3:c.-4dup")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.1_2insCA"))), "NM_000051.3:c.-1_1dup")

        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.*2_*3insT"))), "NM_000051.3:c.*4dup")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.9170_9171insAT"))),
            "NM_000051.3:c.9171_*1dup")

        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.*4_*5insT"))), "NM_000051.3:c.*3dup")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_000051.3:c.9171_*1insA"))), "NM_000051.3:c.9171dup")
    ...
    def test_g_normalizer(self):
        ...
        #3' shuffling
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NC_000006.11:g.49917122_49917123insA"))),
            "NC_000006.11:g.49917127dup")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NC_000006.11:g.49917121_49917122insGA"))),
            "NC_000006.11:g.49917122_49917123dup")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NC_000006.11:g.49917122_49917123dup"))),
            "NC_000006.11:g.49917122_49917123dup")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NC_000006.11:g.49917122_49917123dupGA"))),
            "NC_000006.11:g.49917122_49917123dup")
        self.assertEqual(
        ...
        #5' shuffling
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NC_000006.11:g.49917122_49917123insA"))),
            "NC_000006.11:g.49917123dup")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NC_000006.11:g.49917121_49917122insGA"))),
            "NC_000006.11:g.49917121_49917122dup")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NC_000006.11:g.49917122_49917123dup"))),
            "NC_000006.11:g.49917121_49917122dup")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NC_000006.11:g.49917122_49917123dupGA"))),
            "NC_000006.11:g.49917121_49917122dup")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NC_000006.11:g.49917099delC"))),
            "NC_000006.11:g.49917098del")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NC_000006.11:g.49917151_49917156delinsTCTAAA"))),
            "NC_000006.11:g.49917154_49917155delinsAA")
        self.assertEqual(
            str(
        ...
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NC_000009.11:g.36233991_36233992delCAinsTG"))),
    ...
    def test_norm_var_near_bound(self):
        ...
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.935T>C"))), "NM_001001656.1:c.935T>C")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.945G>C"))), "NM_001001656.1:c.945G>C")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.945dup"))), "NM_001001656.1:c.945dup")
        self.assertEqual(
        ...
        self.assertEqual(
            str(self.normc.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.935T>C"))), "NM_001001656.1:c.935T>C")
        self.assertEqual(
            str(self.normc.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.945G>C"))), "NM_001001656.1:c.945G>C")
        self.assertEqual(
            str(self.normc.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.945dup"))), "NM_001001656.1:c.945dup")
        self.assertEqual(
        ...
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.1A>T"))), "NM_001001656.1:c.1A>T")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.1del"))), "NM_001001656.1:c.1del")
        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.1dup"))), "NM_001001656.1:c.1dup")

        self.assertEqual(
            str(self.norm5c.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.1A>T"))), "NM_001001656.1:c.1A>T")
        self.assertEqual(
            str(self.norm5c.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.1del"))), "NM_001001656.1:c.1del")
        self.assertEqual(
            str(self.norm5c.normalize(self.hp.parse_hgvs_variant("NM_001001656.1:c.1dup"))), "NM_001001656.1:c.1dup")

        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_212556.2:c.1_2insCA"))), "NM_212556.2:c.1_2insCA")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_212556.2:c.2_3insCAT"))), "NM_212556.2:c.2_3insCAT")
        self.assertEqual(
            str(self.norm.normalize(self.hp.parse_hgvs_variant("NM_212556.2:c.1delinsCA"))), "NM_212556.2:c.1delinsCA")

        self.assertEqual(
            str(self.norm5.normalize(self.hp.parse_hgvs_variant("NM_212556.2:c.1_2insCA"))), "NM_212556.2:c.1delinsACA")
        self.assertEqual(
